      ...
      <NCollapseItem :title="$t('common.search')" name="crop-search">
        <NForm ref="formRef" :model="model" label-placement="left" :label-width="100">
          <NGrid responsive="screen" item-responsive>
            <NFormItemGi span="24 s:12 m:6" label="设备名称" path="name" class="pr-24px">
              <NInput v-model:value="params.name"   placeholder="请输入设备名称" />
            </NFormItemGi>
            <NFormItemGi span="24 s:12 m:6" label="设备类型" path="name" class="pr-24px">
              <NSelect v-model:value="params.product" :options="productOptions"   placeholder="选择设备类型" />
            </NFormItemGi>
